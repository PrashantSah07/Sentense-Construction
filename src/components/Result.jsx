...
const Result = () => {
    ...
    return (
        <>
            <Navbar arrow={'←'} />
            <div className="flex flex-col items-center justify-center sm:mt-20 mt-10  max-w-[1050px] mx-auto gap-5 sm:px-10 px-5">
                ...
                <div className="">
                    <p className="sm:text-[18px] text-[17px] font-semibold text-gray-600 text-center">
                ...
                <div className='mb-10'>
                    {sampleJson.data.questions.map((e, i) => (
                        <div key={i} className="border p-4 my-4 rounded-md shadow-md">
                            <p className="font-semibold text-lg mb-2 sm:text-[18px] text-[16px]">{i + 1}. {e.question}</p>
